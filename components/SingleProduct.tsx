                                ...
                                <div className='flex'>
                                    ...
                                    <div className='m-5 w-[70%]'>
                                        ...
                                        <div>
                                            ...
                                            <li className='text-[15px]'>Monster Durability & Display Corning Gorilla Glass Victus, 16.83 Centimeters 6.6 Inch Super AMOLED Display FHD Resolution with 1080 2340 Pixels and 120Hz Refresh Rate</li>
